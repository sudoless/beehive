...
// Parser returned be.HandlerFunc is used in the chain. Otherwise, Request.Values will be nil. This is used
// as an optimization to avoid useless allocating. The be.HandlerFunc returned by Parser also uses a
